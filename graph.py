...
def migrate_video(vid_name,object_file,event_file,mapping_file):
	...
	#Create video node
	video = gdb.nodes.create(name=vid_name)
	...
	print "Created all frame nodes and relationships"


if __name__ == '__main__':
	clear_graph()
	initialize_labels()
	migrate_video("VIRAT_S_000001.mp4","Virat Videos/VIRAT_S_000001/VIRAT_S_000001.viratdata.objects.txt","Virat Videos/VIRAT_S_000001/VIRAT_S_000001.viratdata.events.txt","Virat Videos/VIRAT_S_000001/VIRAT_S_000001.viratdata.mapping.txt")
